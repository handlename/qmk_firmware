...
[L_BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_TAB,     KC_Q,     KC_W,     KC_E,     KC_R,    KC_T,      MO(L_SYST),
        KC_LCTRL,   KC_A,     KC_S,     KC_D,     KC_F,    KC_G,
        KC_LSHIFT,  KC_Z,     KC_X,     KC_C,     KC_V,    KC_B,      MO(L_FUNC),
        ...
        MO(L_SYST), KC_Y,     KC_U,     KC_I,    KC_O,     KC_P,      KC_EQUAL,
                    KC_H,     KC_J,     KC_K,    KC_L,     KC_SCOLON, KC_QUOTE,
        MO(L_FUNC), KC_N,     KC_M,     KC_COMM, KC_DOT,   KC_SLSH,   KC_RSFT,
...
[L_FUNC] = KEYMAP(
       ...
       KC_NO,   KC_NO,   KC_NO,   KC_UP,   KC_NO,   KC_NO,   KC_TRNS,
