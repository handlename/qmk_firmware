...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_5x6(
     ...
     _______,_______,_______,_______,KC_LBRC,KC_SLSH,                        KC_BSLS,KC_RBRC,_______,_______,_______,_______,
     _______,_______,_______,_______,KC_9   ,KC_MINS,                        KC_EQL ,KC_0   ,_______,_______,_______,_______,
