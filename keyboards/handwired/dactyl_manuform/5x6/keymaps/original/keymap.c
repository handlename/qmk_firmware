  ...
  [_BASE] = LAYOUT_5x6(
     ...
     KC_LSFT,KC_SCLN,KC_Q   ,KC_J   ,KC_C   ,KC_X   ,                        KC_B   ,KC_M   ,KC_W   ,KC_V   ,KC_Z   ,KC_RSFT,
                     KC_LEFT,KC_RGHT,                                                        KC_DOWN,KC_UP  ,
                                   ...
                                   LT(RAISE, KC_ESC),KC_ESC ,        KC_ENT ,LT(RAISE, KC_ENT)
  ),

  [_RAISE] = LAYOUT_5x6(

     KC_F1  ,KC_F2  ,KC_F3  ,KC_F4  ,KC_F5  ,KC_F6  ,                        KC_F7  ,KC_F8  ,KC_F9  ,KC_F10 ,KC_F11 ,KC_F12 ,
     _______,_______,KC_QUES,KC_SLSH,KC_LBRC,_______,                        _______,KC_RBRC,KC_BSLS,KC_PIPE,_______,_______,
     _______,_______,KC_UNDS,KC_MINS,KC_LCBR,_______,                        _______,KC_RCBR,KC_EQL ,KC_PLUS,_______,_______,
     _______,_______,_______,_______,KC_9   ,_______,                        _______,KC_0   ,_______,_______,_______,_______,
