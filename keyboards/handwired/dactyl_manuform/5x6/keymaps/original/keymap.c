...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_5x6(
     ...
     KC_LSFT,KC_SCLN,KC_Q   ,KC_J   ,KC_C   ,KC_X   ,                        KC_B   ,KC_M   ,KC_W   ,KC_V   ,KC_Z   ,KC_RSFT,
                     KC_F5  ,KC_F9  ,                                                        KC_F10 ,KC_F11 ,
                                             ...
                                             RAISE  ,KC_ESC ,        KC_ENT ,  RAISE,
                                             LOWER  ,KC_LALT,        KC_RALT,  LOWER
  ),
  ...
  [_LOWER] = LAYOUT_5x6(
     _______,_______,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,_______,
     _______,_______,_______,KC_UP  ,_______,_______,                        _______,KC_P1  ,KC_P2  ,KC_P3  ,_______,_______,
     _______,_______,KC_LEFT,KC_DOWN,KC_RGHT,_______,                        _______,KC_P4  ,KC_P5  ,KC_P6  ,_______,_______,
