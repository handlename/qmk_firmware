...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_GRV,  KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_F9  ,                   XXXXXXX, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , XXXXXXX,
    KC_TAB,  KC_QUOT, KC_COMM, KC_DOT , KC_P   , KC_Y   , KC_F10 ,                   XXXXXXX, KC_F   , KC_G   , KC_K   , KC_R   , KC_L   , KC_SLSH,
    KC_LCTL, KC_A   , KC_O   , KC_E   , KC_U   , KC_I   ,                                     KC_D   , KC_H   , KC_T   , KC_N   , KC_S   , KC_MINS,
    KC_LSFT, KC_SCLN, KC_Q   , KC_J   , KC_C   , KC_X   , KC_F11 ,                   XXXXXXX, KC_B   , KC_M   , KC_W   , KC_V   , KC_Z   , KC_RSFT, XXXXXXX, XXXXXXX, KC_LEFT, KC_RGHT, MO(2)  ,                                                       MO(2)  , KC_DOWN, KC_UP  , XXXXXXX, XXXXXXX,
                                                 XXXXXXX, KC_HOME,                   KC_END , XXXXXXX,
                                                          KC_LALT,                   KC_RALT,
                                        KC_LGUI, KC_SPC , LT(1,KC_ENT),         LT(1,KC_ESC), KC_BSPC, KC_RGUI
  ),
